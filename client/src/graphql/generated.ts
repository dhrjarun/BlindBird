...
export type ChatWithUnreadMsgsQuery = {
  __typename?: 'Query';
  chatWithUnreadMsgs?: {
    __typename?: 'Chat';
    id: number;
    ...
    messages?: Array<{ __typename?: 'Message'; id: number }> | null;
  } | null;
};
...
export type ChatsWithUnreadMsgsQuery = {
  ...
  chatsWithUnreadMsgs?: Array<{
    ...
    revealGender: boolean;
    messages?: Array<{ __typename?: 'Message'; id: number }> | null;
    firstPerson?: { __typename?: 'User'; tId: string; tName: string } | null;
    secondPerson: {
      __typename?: 'User';
      tId: string;
      tName: string;
...
export type ChatFromSecondPersonTIdQuery = {
  __typename?: 'Query';
  chat?: {
    __typename?: 'Chat';
    id: number;
...
export const ChatWithUnreadMsgsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ChatWithUnreadMsgs' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'revealGender' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'firstPerson' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'tUsername' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'tName' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'tId' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'tPfp' } },
                    ],
                  },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'secondPerson' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'tUsername' } },
...
} as unknown as DocumentNode<ChatWithUnreadMsgsQuery, ChatWithUnreadMsgsQueryVariables>;
...
export const ChatsWithUnreadMsgsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<ChatsWithUnreadMsgsQuery, ChatsWithUnreadMsgsQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'revealGender' } },
          type: {
            kind: 'NonNullType',
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'secondPersonTId' },
          },
          type: {
            kind: 'NonNullType',
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'revealGender' },
                value: {
                  kind: 'Variable',
                  name: { kind: 'Name', value: 'revealGender' },
                },
...
export const MarkSeenDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'MarkSeen' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<MarkSeenMutation, MarkSeenMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'cursorType' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'CursorType' } },
        },
        {
          kind: 'VariableDefinition',
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'cursorType' } },
              },
              {
                kind: 'Argument',
...
export const ChatFromIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ChatFromId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'chatId' } },
...
} as unknown as DocumentNode<ChatFromIdQuery, ChatFromIdQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ChatFromSecondPersonTId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'tUsername' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'tUsername' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'tUsername' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'publicMetrics' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
